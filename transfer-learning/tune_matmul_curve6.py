...
def matmul(N, L, M, dtype):
    ...
    # features = get_buffer_curve_sample_flatten_fix(s, args)
    ...
    # names = get_flatten_name(features)
    # print(names)
...
log_file = 'matmul.log'
# log_file = 'matmul-curve6.log'
# begin tuning, log records to file `matmul.log`
# tuner = autotvm.tuner.XGBTuner(task)
# tuner = autotvm.tuner.XGBTuner(task, feature_type='curve')
tuner = autotvm.tuner.XGBTuner(task, feature_type='curve-fix')
