...
def conv2d_no_batching(N, H, W, CO, CI, KH, KW, stride, padding):
    ...
    # print(tvm.autotvm.get_itervar_feature(s, args))
    # print(tvm.autotvm.get_itervar_feature_flatten(s, args))
    # print(dir(ir))
...
def main(feature_type, conv_config):
    filename = 'conv2d_{}_{}'.format(feature_type, conv_config)
...
if __name__ == "__main__":
    ...
    conv_config = sys.argv[2]
    main(feature_type, conv_config)
