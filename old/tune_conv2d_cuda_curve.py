...
def conv2d_no_batching(N, H, W, CO, CI, KH, KW, stride, padding):
    ...
    # print(stmt)
    # feas = _get_itervar_feature(stmt, take_log=False)
    # feas = get_itervar_feature(s, args)
    # feas = get_buffer_curve_sample_flatten(s, args)
    # print(feas)
...
log_file = '/homes/zheng321/cs590/tvm-conv2d/conv2d-curve.log'
